...
static const SDRAMConfig sdram_cfg = {
  .sdcr = (uint32_t)((1 << 0) | (2 << 2) | (1 << 4) | (1 << 6) | (2 << 7) | (0 << 9) | (2 << 10) | (1 << 12) | (0 << 13)),

  .sdtr = (uint32_t)((1 << 0) | (4 << 4) | (3 << 8) | (4 << 12) | (2 << 16) | (1 << 20) | (1 << 24)),

  .sdcmr = (uint32_t)((2 << 5) | (0x224 << 9)), // burst len 2 cas 2 mode single

  .sdrtr = (uint32_t)(724 << 1)
};

/* SDRAM size, in bytes.*/
#define W9825G6KH5_SIZE             (32 * 1024 * 1024)